-- 1
INSERT INTO employees (firstName, lastName, email) VALUES ('Lucas', 'Galleguillo', NULL);
/* la columna email está definida con una restricción NOT NULL, la inserción fallará y 
lanzará un error porque no se permite un valor NULL en esa columna.
*/

-- 2
UPDATE employees SET employeeNumber = employeeNumber - 20;
/* resta 20 a todos los employeeNumber y la resta crea duplicados*/

UPDATE employees SET employeeNumber = employeeNumber + 20;
/* Intenta sumarle 20 a todos los ids pero se encuentra que si le suma 20 a uno 
termina teniendo el mismo valor que el otro (no puede haber dos filas con la misma primary key) */
